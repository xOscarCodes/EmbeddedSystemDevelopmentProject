...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $existSql = "SELECT * FROM `admins` WHERE username = '$username'";
    ...
    if ($numExistRows > 0) {
        ...
        if (($password == $cpassword)) {
            ...
            $sql = "INSERT INTO `admins` (`username`, `password`, `datetime`) VALUES ('$username', '$hash', current_timestamp())";
...
<body>
    ...
    <div class="container my-4">
        <h1 class="text-center">Sign Up SEES Admin</h1>

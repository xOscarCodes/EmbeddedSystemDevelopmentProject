...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql = "SELECT * FROM `kitchen_staff` WHERE username = '$username'";
...
<body>
  ...
  <div class="container my-4">
    <h1 class="text-center">Login SEES Kitchen</h1>
    <form action="../KitchenLogin/Kitchenlogin.php" method="post" style="
     display: flex;
